<%-- 
    Document   : adminlogin
    Created on : 18 juin 2023, 20:54:58
...
<html>
    <head>
        ...
        <title>Evaluation juillet</title>
    ...
    <body>
        <div class="container">
            <div class="form-container sign-in-container" >
                <form action="<%=request.getContextPath()%>/functionlogAdmin" class="formfade"> 
                    <h1>Connecter en tant qu'Administrateur</h1>
